...
On a 1\,km$\times$1\,km synthetic city, a dual-layer front of 32 solutions spans cooperative coverage \(0.07\)--\(0.96\) and non-cooperative coverage \(0.00\)--\(0.56\). Cooperative \(\geq90\%\) is reachable near \$247k while non-cooperative coverage stays near \(0.13\); joint floors near \(0.85/0.35\) cost about \$320k. Airport split fronts and a Paulista lite case reinforce the same asymmetry. Three strengthening controls close prior claim gaps under the \emph{same} ray-tracer: (A)~on enumerable crops \(n\in\{8,10,12\}\), a fixed-$k$ GA matches oracle \(M_c\) within \(0.0\)--\(0.3\)\,pp; (B)~at matched CapEx, RF-only wins lean/mid classic \(M_c\); (C)~dual-layer CapEx ablation shows RF saturates \(M_{wp,coop}\) with zero noncoop, while heterogeneous mixes win \(M_{wp,noncoop}\) at \$320k (\(47.5\%\) with companion coop \(83\%\)). Heterogeneity is required for joint dark-target floors, not for lean classic coverage. We do \emph{not} claim city-scale optimality gaps. Code: \url{https://github.com/andrekuros/SCOPAS_Sensor_Placement}.
\end{abstract}
