...
\textbf{Meta-heuristics}: Genetic Algorithms have successfully addressed network optimization in other domains \cite{zou2019WSN, charlish2016radar}, offering good solution quality with manageable computational requirements. Applications to C-UAS / GBSS placement with urban LoS constraints remain comparatively sparse relative to WSN and radar-array literature.
