...
\begin{enumerate}
    ...
    \item \textbf{Claim-closing controls}: (A)~small-$n$ oracle comparison (Exhaustive / Greedy / Random / GA) under the same ray-tracer; (B)~matched-budget modality ablation (RF / Acoustic / EO / Radar / Heterogeneous). These bound GA gaps where enumeration is feasible and restrict when heterogeneity helps CapEx-matched \(M_c\).
\end{enumerate}
